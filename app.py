...
ITEMS = [
    ...
    # NOTE: Fixed duplicate IDs below (original had 302-307 used twice)
    {"id": 3020, "name": "Amul Strawberry Ice Cream 750ml", "icon": "🍦", "category": "icecream", "base_price": 155},
    {"id": 3030, "name": "Amul Mango Ice Cream 750ml", "icon": "🍦", "category": "icecream", "base_price": 160},
    {"id": 3040, "name": "Kwality Walls Cornetto Chocolate Cone", "icon": "🍦", "category": "icecream", "base_price": 45},
    {"id": 3050, "name": "Kwality Walls Cornetto Butterscotch Cone", "icon": "🍦", "category": "icecream", "base_price": 45},
    {"id": 3060, "name": "Kwality Walls Cornetto Double Chocolate", "icon": "🍦", "category": "icecream", "base_price": 50},
    {"id": 3070, "name": "Kwality Walls Magnum Classic Bar", "icon": "🍦", "category": "icecream", "base_price": 90},
    {"id": 3080, "name": "Kwality Walls Magnum Almond Bar", "icon": "🍦", "category": "icecream", "base_price": 95},
    {"id": 3090, "name": "Kwality Walls Magnum Chocolate Truffle", "icon": "🍦", "category": "icecream", "base_price": 100},
    ...
    # Dairy (Aavin, Amul extended, Milky Mist, Nandini, Mother Dairy)
...
# Deduplicate by ID (last one wins), then re-sort by id
seen = {}
for item in ITEMS:
    seen[item["id"]] = item
...
def compare_prices():
    ...
    # Bar widths: best platform = 60%, worst = 100%
    price_range = worst - best if worst != best else 1
    for idx, r in enumerate(results):
        r["rank"]           = idx + 1
        r["medal"]          = medals[idx]
        r["is_best"]        = idx == 0
        r["savings_vs_best"] = r["total"] - best
        r["bar_width"]      = round(60 + 40 * (r["total"] - best) / price_range)
